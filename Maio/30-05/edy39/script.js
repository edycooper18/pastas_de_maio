...
function exibirLista(lista, elemento) {
    ...
    lista.forEach(item => {
        ...
        li.textContent = `Nome: ${item.nome}, ${item.idade}`;
...
ordenarPorNomeBtn.addEventListener('click', () => handleSortClick(compararPorNome, 'nome'));
ordenarPorIdadeBtn.addEventListener('click', () => handleSortClick(compararPorIdade, 'idade'));